...
music_folder = 'PP2/Lab 7/musics'

button_images = { 
    "Play" : pygame.transform.scale(pygame.image.load('PP2/Lab 7/music_buttons/play.png'),(50,50)),
    "Next" : pygame.transform.scale(pygame.image.load('PP2/Lab 7/music_buttons/next.png'),(50,50)),
    "Back" : pygame.transform.scale(pygame.image.load('PP2/Lab 7/music_buttons/back.png'),(50,50))
}
