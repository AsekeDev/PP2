...
background = pygame.image.load('PP2/Lab 7/images/mickeyclock.png')
right_arm = pygame.image.load('PP2/Lab 7/images/rightarm.png')
left_arm = pygame.image.load('PP2/Lab 7/images/leftarm.png')
