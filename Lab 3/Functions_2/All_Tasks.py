...
print("Highly rated movies:", highly_rated_movies(movies))

print("Thriller movies:", movies_by_category(movies, "Thriller"))

print("Average IMDB score:", average_imdb(movies))

print("Average IMDB score for Romance movies:", average_imdb_by_category(movies, "Romance"))